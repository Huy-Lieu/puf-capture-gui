...
FPGA_INDEX = 12
EXTENSION = ".txt"
SAVE_DIR = fr"D:\All_SelfLearning\Prj\1_\PUF_Experimental_Results\Full_Test\Temperature\Raw2"
...
FILE_PATTERNS = [
    "FPGA{index}_LDIST6_DLUTA_ALUTB_MDIST8_M0_M7_CFF_R1_35",
    "FPGA{index}_LDIST6_DLUTA_ALUTB_MDIST8_M0_M7_CFF_R1_45",
    "FPGA{index}_LDIST6_DLUTA_ALUTB_MDIST8_M0_M7_CFF_R1_55",
    "FPGA{index}_LDIST6_DLUTA_ALUTB_MDIST8_M0_M7_CFF_R1_65",
    "FPGA{index}_LDIST6_DLUTA_ALUTB_MDIST8_M0_M7_CFF_R1_70"
]
# ---------------------
    ...
    try:
        for i, pattern in enumerate(FILE_PATTERNS):
            ...
            if mode == '2':
                ...
                input("Press [Enter] to START in 5s ...")
                time.sleep(AUTO_DELAY)
